...
class ScaffoldRequestsScreen extends StatefulWidget {
  const ScaffoldRequestsScreen({super.key});
          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF0A2A43), Color(0xFF0D3B66)],
                ...
                Expanded(
                  child: FutureBuilder<List<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (requests.isEmpty) {
                        return const Center(
                          child: Text('No scaffold requests found'),
                        );
                      }
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      RequestDetailsScreen(requestId: req['id']),
                                ),
                              );
                            },
                            child: Container(
